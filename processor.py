    ...
    async with factory() as db:
        try:
            ...
            from app.services.review_run_repository import (
                update_review_run_status, get_review_run
            )
            ...
            # Step 5 — Fetch PR files and build position maps
            ...
            # Step 8 — Post to GitHub (skip in mock mode)
            ...
            # Step 10 — Update review run as completed
